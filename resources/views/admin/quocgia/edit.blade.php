...
<div class="content-wrapper">
    ...
    <hr>
    <form action="{{route('quocgia.update', $quocgia->id)}}" method="POST" role="form">
    @csrf @method('PUT')
    <div class="form-group">
          <label for="">id phim</label>
          <input type="text" value="{{$quocgia->id}}" class="form-control" name="id" placeholder="id">
          @error('name')
        ...
        <div class="form-group">
          ...
          <input type="text" value="{{$quocgia->name}}" class="form-control" name="name" placeholder="nhập tên loại phim">
          @error('name')
          <small class="form-text text-muted">{{$message}}</small>
          @enderror
        </div>
