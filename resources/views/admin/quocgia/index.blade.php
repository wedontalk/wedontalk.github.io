    ...
    <table class="table table-hover">
            ...
            @foreach($data as $t)
                <tr>
                    ...
                    <td class="text-right">
                    <a href="{{route('quocgia.edit',$t->id)}}" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
                        <a href="{{route('quocgia.destroy',$t->id)}}" class="btn btn-sm btn-danger btndelete"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
