    ...
    <x-alert></x-alert>
            ...
            @foreach($data as $t)
                <tr>
                    ...
                    <td class="text-right">
                        <a href="{{route('phimchieurap.edit',$t->id)}}" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
                        <a href="{{route('phimchieurap.destroy',$t->id)}}" class="btn btn-sm btn-danger btndelete"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
            <a href="phimchieurap/create">thêm phim chiếu rạp</a>
        </table>
