            ...
            @foreach($data as $t)
                <tr>
                    ...
                    <td class="text-center">
                        @if($t->role == 0)
                            <span class="badge badge-danger">tk admin</span>
                        @else
                            <span class="badge badge-success">tk user</span>
                        @endif
                    </td>
                    <td class="text-right">
                        <a href="{{route('account.edit',$t->id)}}" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
                        <!-- <a href="{{route('loaiphim.destroy',$t->id)}}" class="btn btn-sm btn-danger btndelete"><i class="fas fa-trash"></i></a> -->
                    </td>
                </tr>
            @endforeach
            </tbody>
