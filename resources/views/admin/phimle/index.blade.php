    ...
    <x-alert></x-alert>
            ...
            @foreach($data as $t)
                <tr>
                    ...
                    <td class="text-right">
                        <a href="{{route('phimle.edit',$t->id)}}" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
                        <a href="{{route('phimle.destroy',$t->id)}}" class="btn btn-sm btn-danger btndelete"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
            <a href="phimle/create">thêm phim lẻ</a>
        </table>
