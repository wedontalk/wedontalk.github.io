...
<link href="{{'public/site'}}/css/style_info_account.min.css" type="text/css" rel="stylesheet"> 
@section('main')
            <style>
            #logout{
              ...
              <li class="home"><a href="index.php" title=""></a></li>
                <li class=""><a></a>
                  <ul class="sub-menu" style="width: 260px; display: none;">
                    <li class=""><a href="?mod=list&type='.$handle.'&id='.$r1['id'].'"></a></li>
                    <li class=""><a href="?mod=list&type='.$handle.'&year='.$r1['year'].'"></a></li>
                  </ul>
                </li>
            </ul>
          </div>
