...
<div class="wrapper">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          @if(Route::has('login'))
            ...
            <a href="{{ route('logout')}}" title="Đăng xuất" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Đăng xuất</a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="">Nguyễn Khánh Duy</a>.</strong> All rights reserved.
  </footer>
...
<script src="{{asset('adm/plugins/jquery-validation/additional-methods.min.js')}}"></script>
<!-- AdminLTE App -->
